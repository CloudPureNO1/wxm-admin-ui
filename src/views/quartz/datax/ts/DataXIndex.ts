...
export const init = () => {
  ...
  const colList = ref<BaseType<any>[]>([
    ...
    { prop: 'triggerState', label: '当前触发器状态', show: true, formatter: (row:any) => useFormatRbacDict(row, 'triggerState'), search: { elType: 'select', piniaDict: 'rbac' },
      ops: [
        { value: 'ACQUIRED', render: handlePause, content: '停止任务', permission: ['quartz-datax:pause'], type: 'success' },
        { value: 'WAITING', render: handlePause, content: '停止任务', permission: ['quartz-datax:pause'], type: 'primary' },
        { value: 'BLOCKED', render: handlePause, content: '停止任务', permission: ['quartz-datax:pause'], type: 'danger' },
        { value: 'ERROR', render: handlePause, content: '停止任务', permission: ['quartz-datax:pause'], type: 'danger' },
        { value: 'PAUSED', render: handleResume, content: '恢复任务', permission: ['quartz-datax:resume'], type: 'danger' }
      ] },
